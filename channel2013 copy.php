...
try {
    $stmt_subs = $pdo->prepare("SELECT COUNT(*) AS total_subscribers FROM subscriptions WHERE $channel_name = ?");
    $stmt_subs->execute([$channel_name]);
...
<body>
    <div class="main-layout">  <div class="channel-container">
        <?php 
            ...
            <div class="channel-header-bar">
                <div id="channel-principal-info" style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
                    ...
                    <a href="dashboard.php?tab=layout-tab">
                        <button style="width: 157px; border-radius: 0px;">Configurar Layout</button>
                    </a>
                    <?php endif; // Fim do bloco if ($is_owner) ?>
                </div>
