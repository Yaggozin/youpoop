...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['set_featured_video'])) {
    ...
    try {
        ...
        header("Location: dashboardold.php?tab=customization-tab&status=feature_success");
        exit;
        ...
        if (move_uploaded_file($_FILES['video_file']['tmp_name'], $video_dest_path) &&
            move_uploaded_file($_FILES['thumbnail_file']['tmp_name'], $thumbnail_dest_path)) {
                ...
                try {
                    ...
                    // SUCESSO COMPLETO
                    header("Location: dashboardold.php?tab=my-videos-tab&status=success&title=" . urlencode($final_title));
                    exit;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['customize_channel'])) {
    ...
    try {
        if (!empty($sql_parts)) {
            ...
            header("Location: dashboardold.php?tab=customization-tab&status=custom_success");
            exit;
        } else {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit_video_settings'])) {
    ...
    if (!$video_id || empty($new_title)) {
        ...
        try {
            ...
            if ($stmt->rowCount() > 0) {
                header("Location: dashboardold.php?tab=my-videos-tab&status=edit_success");
                exit;
            } else {
    ...
    try {
        ...
        if ($file_paths) {
            ...
            if ($stmt_delete->rowCount() > 0) {
                ...
                header("Location: dashboardold.php?tab=my-videos-tab&status=delete_success");
                exit;
            } else {
...
<body>
    ...
    <nav class="main-nav">
        ...
        <a href="dashboardold.php?tab=upload-tab" class="main-nav-item">
            UPLOAD
        </a>
...
<div class="dashboard-container">
    ...
    <div class="dashboard-tabs">
        <a href="dashboardold.php?tab=overview-tab" class="dashboard-tab-item <?php echo ($active_tab == 'overview-tab' ? 'active-tab' : ''); ?>">Visão Geral</a>
        <a href="dashboardold.php?tab=my-videos-tab" class="dashboard-tab-item <?php echo ($active_tab == 'my-videos-tab' ? 'active-tab' : ''); ?>">Meus Vídeos</a>
        <a href="dashboardold.php?tab=upload-tab" class="dashboard-tab-item <?php echo ($active_tab == 'upload-tab' ? 'active-tab' : ''); ?>">Enviar Vídeo</a>

        <a href="dashboardold.php?tab=account-settings-tab" class="dashboard-tab-item 
            <?php echo ($active_tab == 'account-settings-tab') ? 'active-tab' : ''; ?>">
            Config. Conta
        </a>
        
        <a href="dashboardold.php?tab=customization-tab" class="dashboard-tab-item 
    ...
    <div id="upload-tab" class="tab-content <?php echo ($active_tab == 'upload-tab' ? 'active' : ''); ?>">
        ...
        <div class="form-section">
            <form method="POST" enctype="multipart/form-data" action="dashboardold.php">
    ...
    <div id="customization-tab" class="tab-content <?php echo ($active_tab == 'customization-tab' ? 'active' : ''); ?>">
        ...
        <div class="dashboard-section featured-highlight">
            ...
            <form method="POST" action="dashboardold.php?tab=customization-tab">
        ...
        <form action="dashboardold.php?tab=customization-tab" method="POST" enctype="multipart/form-data" class="upload-form">
        ...
        <div id="account-settings-tab" class="tab-content <?php echo ($active_tab == 'account-settings-tab' ? 'active' : ''); ?>">
            ...
            <form action="dashboardold.php?tab=account-settings-tab" method="POST" style="padding: 15px; border: 1px solid #ccc; background-color: #FFFFCC;">
...
<div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <div class="form-section">
            <form id="edit-form" method="POST" action="dashboard.phpold">
...
<div id="deleteModal" class="modal">
    <div class="modal-content">
        ...
        <form id="delete-form" method="POST" action="dashboardold.php">
