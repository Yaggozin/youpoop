...
try { 
    ...
    if (!$channel_info) {
        // Se o canal não existe, redirecionamos.
        header("Location: 404.php"); // Redireciona para a página inicial
        exit; // Interrompe a execução
    }
...
<head>
    ...
    <style>
        ...
        :root {
            --cor-topbar: #666666;
            --cor-principal: #ffffff; /* cor padrão */
            --cor-involucro: #d5d5d5; /* cor do invólucro, antes era #999999 */
            --cor-texto: #000000;
            --cor-texto-destaque: #ffffff;
            --cor-link: #0000CC;
            --transparencia: true;
            --repeat: false;
            /* Variável interna para controlar a cor de fundo real (sólida ou transparente) via JS */
            --bg-channel-info: var(--cor-principal);
        }
        ...
        <div id="channel-container">
            ...
            <div class="channel-settings">
                ...
                <div id="banner-editor-box">
                    ...
                    <div class="editor-row" style="display: block; margin-bottom: 10px;">
                        <label style="display:block; margin-bottom: 3px; font-weight:bold;">URL da Imagem:</label>
                        <input type="text" id="input-banner-url" style="width: 95%;" placeholder="http://...">
                    </div>

                    <div class="editor-row" style="display: block;">
                        <label style="display:block; margin-bottom: 3px; font-weight:bold;">Código do Mapa (&lt;area&gt;):</label>
                        <textarea id="input-banner-map" rows="6" style="width: 95%; resize: vertical; font-family: monospace; font-size: 11px;" placeholder='<area shape="rect" coords="0,0,100,100" href="#">'></textarea>
                        <small style="color: #555;">Cole apenas as tags &lt;area&gt; aqui dentro.</small>
                    </div>
                ...
                <div id="theme-editor-box">
                    ...
                    <div class="editor-row">
                        <label>Cor do Invólucro:</label>
                        <input type="color" id="input-cor-involucro" value="#999999">
                    </div>
                    <div class="editor-row">
                        <label>Cor da Barra Superior:</label>
                        <input type="color" id="input-cor-topbar" value="#666666">
                    </div>
                    <div class="editor-row">
                        <label>Cor Principal:</label>
                        <input type="color" id="input-cor-principal" value="#ffffff">
                    </div>
                    <div class="editor-row">
                        <label>Cor do Texto:</label>
                        <input type="color" id="input-cor-texto" value="#000000">
                    </div>
                ...
                <div id="background-editor-box">
                    ...
                    <div class="editor-row" style="display: block; margin-bottom: 10px;">
                        <label style="display:block; margin-bottom: 3px; font-weight:bold;">URL da Imagem de Fundo (Máx. 2MB):</label>
                        <input type="text" id="input-background-url" style="width: 95%;" placeholder="http://...">
                    </div>
            ...
            <div id="channel-banner">
                <img src="test/bannerexplorer.png" usemap="#image-map-banner">
            </div>

            <map name="image-map-banner">
                <area target="_blank" alt="Explorer Download" title="Explorer Download" href="https://www.microsoft.com/pt-br/download/internet-explorer" coords="544,139,423,11" shape="rect">
            </map>
                    ...
                    <div class="channel-info">
                        ...
                        <div class="info">
                            ...
                            <div class="obb">
                                ...
                                <h3 class="taai">October 04, 2009</h3>
                            </div>
                        ...
                        <div class="info">
                            <div class="channels">
                                <div class="channel-card">
                                    <div class="avatar-big">
                                        <img style="height: 60px; width: 60px;" src="https://web.archive.org/web/20101229125123im_/http://i4.ytimg.com/i/cNbcQD6zHLPSfcxgFRGiEg/1.jpg?v=abe6a4" alt="avatar">
                                    </div>
                                    <h3>viralsequel</h3>
                                </div>
                            </div>
