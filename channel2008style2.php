...
<head>
    ...
    <style>
        ...
        .channel-nav-title-bar .subscribe-container {
            float: left;
            padding-top: 10px;
            display: inline;
        }
        ...
        <div id="channel-container">
            ...
            <div class="channl">
                ...
                <div class="channel-header">
                    <div class="channel-nav-title-bar">
                        <div class="avatarr">
                            <img src="<?php echo htmlspecialchars($icon_path); ?>" alt="avatar">
                        </div>

                        <div class="uwu" style="float: left; padding: 0.4em;">
                            <h2>Nome</h2>
                            <h4>whruwjmdnwid's Channel</h4>
                        </div>
