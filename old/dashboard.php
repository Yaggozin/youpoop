...
// Vamos buscar os dados de layout/cores
$channel_colors = [
    'quadradop' => $channel_info['color_quadradop'] ?? '#FFFFFF', 
    'left-section-ytg-box' => $channel_info['color_left_section'] ?? '#F0F0F0',
    'upper-section-ytg-box' => $channel_info['color_upper_section'] ?? '#FFFFFF',
    'sections-ytg-box' => $channel_info['color_sections'] ?? '#FFFFFF',
];
...
<head>
    ...
    <style>
        ...
        */
        ...
        /* --- ESTILOS ANTIGOS (2008) PARA O LAYOUT DO CANAL --- */
        ...
        /* Cabeçalho da Caixa (Onde está o Título "Layout do Canal...") */
        .legacy-form-header {
        ...
        .legacy-form-group label {
            ...
            font-weight: bold;
            color: #333;
            flex-basis: 70%; /* Dá mais espaço para o label */
        }

        /* Campos de Input e Select */
        .legacy-form-box input[type="color"],
        .legacy-form-box .legacy-select {
            border: 1px solid #7F7F7F;
            padding: 2px;
            background-color: #FFF;
            font-size: 11px;
            flex-basis: 25%; /* Alinha o campo à direita */
            height: 25px;
            cursor: pointer;
        }
